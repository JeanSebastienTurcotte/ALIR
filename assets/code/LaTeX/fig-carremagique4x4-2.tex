...
\begin{scope}[on background layer]
    \filldraw[cyan!80, rounded corners] (m-3-2.north west) -- 
    ...
    \filldraw[cyan!80, rounded corners] (m-3-3.north west) -- 
        ...
        cycle;
    \filldraw[cyan!80, rounded corners] (m-2-2.north west) -- 
        (m-2-2.north east) -- (m-2-2.south east)-- (m-2-2.south west)-- 
        cycle;
    \filldraw[cyan!80, rounded corners] (m-2-3.north west) -- 
    ...
    \filldraw[yellow!80, rounded corners] (m-1-1.north west) -- 
        ...
        cycle;
    \filldraw[yellow!80, rounded corners] (m-1-4.north west) -- 
        (m-1-4.north east) -- (m-1-4.south east)-- (m-1-4.south west)-- 
        cycle;
    \filldraw[yellow!80, rounded corners] (m-4-4.north west) -- 
        (m-4-4.north east) -- (m-4-4.south east)-- (m-4-4.south west)-- 
        cycle;
    \filldraw[yellow!80, rounded corners] (m-4-1.north west) -- 
        (m-4-1.north east) -- (m-4-1.south east)-- (m-4-1.south west)-- 
        cycle;
        %%%
    \filldraw[green!80, rounded corners] (m-1-2.north west) -- 
    ...
    \filldraw[green!80, rounded corners] (m-1-3.north west) -- 
        ...
        cycle;
    \filldraw[green!80, rounded corners] (m-4-2.north west) -- 
        (m-4-2.north east) -- (m-4-2.south east)-- (m-4-2.south west)-- 
        cycle;
    \filldraw[green!80, rounded corners] (m-4-3.north west) -- 
        (m-4-3.north east) -- (m-4-3.south east)-- (m-4-3.south west)-- 
        cycle;
        %%%
    \filldraw[red!80, rounded corners] (m-2-1.north west) -- 
    ...
    \filldraw[red!80, rounded corners] (m-3-1.north west) -- 
        ...
        cycle;
    \filldraw[red!80, rounded corners] (m-2-4.north west) -- 
        (m-2-4.north east) -- (m-2-4.south east)-- (m-2-4.south west)-- 
        cycle;
    \filldraw[red!80, rounded corners] (m-3-4.north west) -- 
        (m-3-4.north east) -- (m-3-4.south east)-- (m-3-4.south west)-- 
        cycle;
\end{scope} 
\end{tikzpicture}}\hspace{-209pt}
$
\end{document}